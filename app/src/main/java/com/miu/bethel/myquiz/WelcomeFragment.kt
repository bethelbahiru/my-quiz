...
class WelcomeFragment : ParentFragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.layout_welcome, container, false)
        ...
        btnSkip?.setOnClickListener { openLandingPage() }
    ...
    private fun openLandingPage(view: View? = null) {
        constants!!.launchFirstTime(false)
